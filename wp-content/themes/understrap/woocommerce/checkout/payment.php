...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		<noscript>
			...
			<br/><input type="submit" class="btn btn-danger" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'understrap' ); ?>" />
		</noscript>
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="btn btn-danger" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
